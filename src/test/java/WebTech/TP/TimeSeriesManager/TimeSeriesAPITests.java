...
import WebTech.TP.TimeSeriesManager.api.controller.TimeSeriesAPIController;
...
@WebMvcTest(controllers = TimeSeriesAPIController.class)
...
public class TimeSeriesAPITests {
    ...
    @BeforeEach
    public void init() {
        List<UserTimeSeriesAccess> list = new ArrayList<>();
        list.add(new UserTimeSeriesAccess("readonly", "1", false));
        list.add(new UserTimeSeriesAccess("canedit", "1", true));
        timeSeries_Main = new TimeSeries("1", "Test1", "Description1", "admin", list, null);
        timeSeriesList_GET = new ArrayList<TimeSeries>();
        timeSeriesList_GET.add(new TimeSeries("1", "Test1", "Description1", "canedit", new ArrayList<>(), null));
        list = new ArrayList<>();
        list.add(new UserTimeSeriesAccess("canedit", "2", true));
        timeSeriesList_GET.add(new TimeSeries("2", "Test2", "Description2", "admin", list, null));
        list = new ArrayList<>();
        list.add(new UserTimeSeriesAccess("readonly", "3", false));
        timeSeriesList_GET.add(new TimeSeries("3", "Test3", "Description3", "admin", list, null));
    }
    ...
    void TestGetTimeSeriesForbidden() throws Exception {
        ...
        ResultActions resp = mockMvc.perform(get(API_URL + "/1")
                .contentType(MediaType.APPLICATION_JSON));
